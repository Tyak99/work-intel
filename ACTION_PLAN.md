...
### 0.1 Fix Supabase RLS — The #1 Critical Issue
...
### 0.3 Stop Returning Integration Secrets to Frontend
**Effort: Small | Impact: Critical**
...
### 1.1 Switch Default Theme to Professional/Clean
...
### 1.3 Add Favicon, Logo, OG Tags, Meta
...
- Free tier: 1 team, 5 members, weekly reports, 4 weeks history
- Team: $10/seat/month (annual) / $12/seat/month (monthly)
- Business: $18/seat/month (annual) — SSO, Jira, API access (future)

### 1.6 Add Privacy Policy and Terms of Service
...
### 1.7 Add Email Unsubscribe Links
...
Zero production observability. If the cron job fails, emails bounce, or API errors spike, nobody knows. Sentry free tier covers this.

### 1.10 Add Invite Token Expiry
**Effort: Small | Impact: Medium (security)**
...
### 2.4 Add Error Boundaries and 404 Page
...
### 2.6 Add Remove Member Confirmation Dialog
...
### 2.8 Add Input Validation with Zod
...
### 3.3 Add Analytics (PostHog/Mixpanel)
...
### 3.5 Prepare Product Hunt Launch
...
"Invite another team, get 1 month free." Engineering managers know other engineering managers.

### 3.8 Add Structured Logging and Audit Trail
...
### 3.10 Add Missing Database Indexes
